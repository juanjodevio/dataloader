...
- Source: Protocol for reading data in batches (deprecated, use Connector)
- Destination: Protocol for writing batches (deprecated, use Connector)
"""
...
class Source(Protocol):
    ...
    .. deprecated:: 
        Use :class:`Connector` instead. This protocol is kept for backward compatibility.
